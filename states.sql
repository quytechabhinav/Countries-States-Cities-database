...
--
-- Host: localhost:3306
-- Generation Time: Aug 02, 2021 at 08:47 AM
...
--
-- Table structure for table `crm_states`
--
...
INSERT INTO `crm_states` (`id`, `name`, `country_id`, `region`) VALUES
(1, 'Andaman and Nicobar Islands', 101, 'South'),
(2, 'Andhra Pradesh', 101, 'South'),
(3, 'Arunachal Pradesh', 101, 'North East'),
(4, 'Assam', 101, 'North East'),
(5, 'Bihar', 101, 'East'),
(6, 'Chandigarh', 101, 'North'),
(7, 'Chhattisgarh', 101, 'West'),
(8, 'Dadra and Nagar Haveli', 101, 'West'),
(9, 'Daman and Diu', 101, 'West'),
(10, 'Delhi', 101, 'North'),
(11, 'Goa', 101, 'West'),
(12, 'Gujarat', 101, 'West'),
(13, 'Haryana', 101, 'North'),
(14, 'Himachal Pradesh', 101, 'North'),
(15, 'Jammu and Kashmir', 101, 'North'),
(16, 'Jharkhand', 101, 'East'),
(17, 'Karnataka', 101, 'South'),
(18, 'Kerala', 101, 'South'),
(19, 'Lakshadweep', 101, 'South'),
(20, 'Madhya Pradesh', 101, 'West'),
(21, 'Maharashtra', 101, 'West'),
(22, 'Manipur', 101, 'North East'),
(23, 'Meghalaya', 101, 'North East'),
(24, 'Mizoram', 101, 'North East'),
(25, 'Nagaland', 101, 'North East'),
(26, 'Odisha', 101, 'East'),
(27, 'Pondicherry', 101, 'South'),
(28, 'Punjab', 101, 'North'),
(29, 'Rajasthan', 101, 'West'),
(30, 'Sikkim', 101, 'North East'),
(31, 'Tamil Nadu', 101, 'South'),
(32, 'Telangana', 101, 'South'),
(33, 'Tripura', 101, 'North East'),
(34, 'Uttar Pradesh', 101, 'North'),
(35, 'Uttarakhand', 101, 'North'),
(36, 'West Bengal', 101, 'East'),
(337, 'Bagar Hat', 18, ''),
(338, 'Bandarban', 18, ''),
(339, 'Barguna', 18, ''),
(340, 'Barisal', 18, ''),
...
(3146, 'Al Khobar', 154, ''),
(3147, 'Aseer', 154, ''),
(3148, 'Ash Sharqiyah', 154, ''),
(3149, 'Asir', 154, ''),
(3150, 'Central Province', 154, ''),
(3151, 'Eastern Province', 154, ''),
(3152, 'Ha\'il', 154, ''),
(3153, 'Jawf', 154, ''),
(3154, 'Jizan', 154, ''),
(3155, 'Makkah', 154, ''),
...
(3157, 'Qasim', 154, ''),
(3158, 'Tabuk', 154, ''),
(3159, 'Western Province', 154, ''),
(3160, 'al-Bahah', 154, ''),
(3161, 'al-Hudud-ash-Shamaliyah', 154, ''),
(3162, 'al-Madinah', 154, ''),
(3163, 'ar-Riyad', 154, ''),
(3186, 'Singapore', 196, ''),
(3254, 'A Coruna', 205, ''),
...
--
-- Indexes for table `crm_states`
--
ALTER TABLE `crm_states`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `crm_states`
--
ALTER TABLE `crm_states`
